...
/* $Id: main.c 1866 2008-09-17 10:24:55Z Paul_R $ */
...
static int prog_usb(char const *filename)
{
    ...
    sprintf(command_str, "dfu-programmer at89c5130 erase");
    ...
    sprintf(command_str, "dfu-programmer at89c5130 flash %s", filename);
    log_info(command_str);
    ret = system(command_str);
    if (ret)
    {
    ...
    sprintf(command_str, "dfu-programmer at89c5130 configure HSB 0x7b");
    log_info(command_str);
    ret = system(command_str);
    if (ret)
    {
    ...
    sprintf(command_str, "dfu-programmer at89c5130 start");
    log_info(command_str);
    ret = system(command_str);
    display_OK();
    fux_disconnect();
